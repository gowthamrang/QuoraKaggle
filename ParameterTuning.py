...
cmdlist = [
    "python Models.py --internal_dim 100 --seq_len 100 --dropout 0.25 --lr 0.01".split(" "),
    #"python Models.py --internal_dim 100 --seq_len 100 --dropout 0.25 --embedding glove --lr 0.003".split(" "),
    #"python Models.py --internal_dim 100 --seq_len 100 --dropout 0.25 --embedding glove --lr 0.1".split(" "),
]
for cmd in cmdlist:
